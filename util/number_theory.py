...
import random
import sympy
from util.barrette import BarrettReducer   # Use MontgomeryReducer if desired
...
def root_of_unity(order, modulus):
    ...
    Args:
        ...
        modulus (int): Modulus to find the root of unity in. Note: MUST BE PRIME
    Returns:
